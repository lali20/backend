...
public class AwsS3Service {
    ...
    private final String bucketName = "phegon";
	...
	private String s3LocationImage;

    public String saveImageToS3(MultipartFile photo) {
        setS3LocationImage(null);
	...
	public String getS3LocationImage() {
		return s3LocationImage;
	}

	public void setS3LocationImage(String s3LocationImage) {
		this.s3LocationImage = s3LocationImage;
	}
}
